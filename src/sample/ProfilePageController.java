...
public class ProfilePageController implements Initializable {
    ...
    @FXML
    private Button contractFarmingButton;
    ...
    public void updateProfileButtonResponse(ActionEvent e) throws IOException {
        ...
        Parent root = (Parent) loader.load();
        UpdateProfilePageController upc = loader.getController();
        upc.first(name,phoneNo);
        Scene scene = new Scene(root, 750, 600);
    ...
    @FXML
    public void contractFarmingButtonResponse(ActionEvent e) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("ContractFarming.fxml"));
        Parent root = (Parent) loader.load();
        ContractFarmingController cfc = loader.getController();
        cfc.first(name,phoneNo);
        Scene scene = new Scene(root, 681, 530);
        Main.primaryStage.setTitle("ContractFarming Page");
        Main.primaryStage.setScene(scene);
        Main.primaryStage.show();
    }
}
